...
describe("RequestParser", () => {
  it("can process valid credit request", () => {
    ...
    expect(RequestParser.parseAccountBody(body)).to.eql({ address: "abc", ticker: "CASH" });
  });
  ...
  it("throws for invalid credit requests", () => {
    ...
    // ticker unset
    {
      ...
      expect(() => RequestParser.parseAccountBody(body)).to.throw(/Property 'ticker' must be a string/i);
    }
    ...
    // ticker empty
    {
      ...
      expect(() => RequestParser.parseAccountBody(body)).to.throw(/Property 'ticker' must not be empty/i);
    }
  });
});
